<%@ Page Title="Etkinlik Ekle" Language="C#" AutoEventWireup="true" CodeBehind="AddEventView.aspx.cs" Inherits="Evant.Views.AddEventView" %>
...
<head>
    ...
    <title>Listable — A Friendly Directory WordPress Theme</title>
    <style type="text/css">
...
<body class="home page page-id-206 page-template page-template-page-templates page-template-front_page page-template-page-templatesfront_page-php wp-custom-logo listable" data-mapbox-token="pk.eyJ1IjoiZ2Vvcmdlb2xhcnUiLCJhIjoiY2lneTNtZ2VtMDBlNmtya3IzdHY0ZTl2biJ9.ZQPEMiJW_XQjJHUFRlioug" data-mapbox-style="mapbox.streets-basic">
    <header id="masthead" class="site-header  header--transparent" role="banner">
        <div class="site-branding  site-branding--image">
             <a href="/Views/HomeView.aspx"> <img src="/Views/assets/img/evant-small.png" class="custom-logo" alt="listable-logo" itemprop="logo"></a>
        </div>
    </header>
    <div class="lwa">
        <div class="lwa-modal" style="display: block; top: 100px; opacity: 1; visibility: visible;">
            ...
            <form runat="server" name="lwa-form" class="lwa-form  lwa-login  js-lwa-login  form-visible">
                <p>
                    <label runat="server" class="color">Event Name</label>
                    <input runat="server" id="eventName" class="input" type="text">
                </p>
                <p>
                    <label runat="server" class="color">Description</label>
                    <textarea runat="server" id="description" name="comment" cols="45" rows="8" aria-required="true" required="required" placeholder="Tell about your experience or leave a tip for others"></textarea>
                </p>
                <p>
                    <label runat="server" class="color">City</label>
                    <input runat="server" ID="city" class="input" type="text"/>
                </p>
                <p>
                    <label runat="server" class="color">Start Date</label>
                    <input runat="server" ID="startDate" class="input" placeholder="22/11/2016" type="text"/>
                </p>
                <p>
                    <label runat="server" class="color">Category</label>
                    <asp:DropDownList ID="categoryList" runat="server" OnSelectedIndexChanged="Category_Click"></asp:DropDownList>
                </p>
                <p>
                    <button runat="server" onserverclick="CreateEvent_Click" type="submit"><span>Save</span></button>
                </p>
            </form>
