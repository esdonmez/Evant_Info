<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="PersonView.aspx.cs" Inherits="Evant.Views.PersonView" %>
...
<body class="single single-job_listing postid-569 wp-custom-logo listable" data-mapbox-token="pk.eyJ1IjoiZ2Vvcmdlb2xhcnUiLCJhIjoiY2lneTNtZ2VtMDBlNmtya3IzdHY0ZTl2biJ9.ZQPEMiJW_XQjJHUFRlioug" data-mapbox-style="mapbox.streets-basic">
    <form runat="server">
                                    ...
                                    <header class="entry-header" style="display: flex">
                                        <div style="display: flex; width: 100%">
                                            <div style="display: flex; width: 85%">
                                                <div style="vertical-align: central; align-self: center; padding-right: 1rem" class="comment-author vcard">
                                            ...
                                            <div style="text-align: center; cursor: pointer; align-self: flex-end; align-self: center; vertical-align: central; width: 15%">
                                                <asp:LinkButton ID="FollowButton" ForeColor="White" CssClass="btn" OnCommand="Follow_Click" CommandName="Follow_Click" CommandArgument='<%#Eval("Id") %>' runat="server" />
                                            </div>
                                        </div>
                                    </header>
                                                                                ...
                                                                                <div style="display: flex; padding-top: 2rem; padding-bottom: 2rem; width: 100%" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-927 comment">
                                                                                    ...
                                                                                    <div style="display: flex">
                                                                                        <div>
                                                                                            ...
                                                                                            <div style="text-align: left">
                                                                                                <asp:Label runat="server" Text='Başlangıç : ' ForeColor="Coral" Font-Size="Small"></asp:Label>
                                                                                        ...
                                                                                        <div style="text-align: end; align-self: center; vertical-align: central; padding-left: 2rem">
                                                                                            <asp:LinkButton Style="font-size: small" runat="server" ID="EventButton" CommandArgument='<%#Eval("Id") %>' OnCommand="Event_Click" Text="Go to Details >"></asp:LinkButton>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </ItemTemplate>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <div style="display: flex; padding-top: 1rem; padding-bottom: 1rem" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-927 comment">
                                                                                    ...
                                                                                    <div style="display: flex; width: 100%">
                                                                                        ...
                                                                                        <div style="text-align: center; cursor: pointer; align-self: flex-end; align-self: center; vertical-align: central; width: 40%">
                                                                                            <asp:LinkButton Style="font-size: small" runat="server" ID="FollowerButton" CommandArgument='<%#Eval("Id") %>' OnCommand="Person_Click" Text="Go to Details >"></asp:LinkButton>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </ItemTemplate>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <div style="display: flex; padding-top: 1rem; padding-bottom: 1rem" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-927 comment">
                                                                                    ...
                                                                                    <div style="display: flex; width: 100%">
                                                                                        ...
                                                                                        <div style="text-align: center; cursor: pointer; align-self: flex-end; align-self: center; vertical-align: central; width: 40%">
                                                                                            <asp:LinkButton Style="font-size: small" runat="server" ID="FollowingButton" CommandArgument='<%#Eval("Id") %>' OnCommand="Person_Click" Text="Go to Details >"></asp:LinkButton>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </ItemTemplate>
        ...
        <style id="wc-social-login-frontend-inline-css" type="text/css">
            al-login.button-social-login-facebook, .widget-ar a a.button-scial-login.button-social-login-facebook, .social- adge.social-badge-facebook {
                und: #3b599;
                n-social-login .button-social-login-google, .widget- rea a.buttonsocial-login.button-social-login-google, .social-ba ge.social-badge-google;
            ...
            {
                und: #3b599;
                utton-social-login .button-social-login-google, .widget-area a.button-social-login.button-social-login-google, .social-badge.social-badge-google;
