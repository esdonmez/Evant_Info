<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SettingsView.aspx.cs" Inherits="Evant.Views.SettingsView" %>
...
<body class="home page page-id-206 page-template page-template-page-templates page-template-front_page page-template-page-templatesfront_page-php wp-custom-logo listable" data-mapbox-token="pk.eyJ1IjoiZ2Vvcmdlb2xhcnUiLCJhIjoiY2lneTNtZ2VtMDBlNmtya3IzdHY0ZTl2biJ9.ZQPEMiJW_XQjJHUFRlioug" data-mapbox-style="mapbox.streets-basic">
    ...
    <div class="lwa">
        <div class="lwa-modal" style="display: block; top: 100px; opacity: 1; visibility: visible;">
            <form runat="server" name="lwa-register" class="lwa-register  lwa-form  js-lwa-register form-visible">
                <p>
                    <label class="color" for="username">Old Password *</label>
                    <input runat="server" name="user_login" id="oldPassword" type="text">
                </p>
                <p>
                    <label class="color" for="email">New Password *</label>
                    <input runat="server" name="user_login" id="newPassword" type="text">
                </p>
                <p>
                    <label class="color" for="user_email">New Password (Again) *</label>
                    <input runat="server" name="user_email" id="newPasswordAgain" type="password">
                </p>
                <p class="lwa-submit-wrapper">
                    <button runat="server" onserverclick="Save_Click" type="submit"><span class="button-arrow">Save</span></button>
                </p>
                <p></p>
                <p class="lwa-submit-wrapper">
                    <button runat="server" onserverclick="DeleteAccount_Click" type="submit"><span class="button-arrow">Delete Account</span></button>
                </p>
            </form>
