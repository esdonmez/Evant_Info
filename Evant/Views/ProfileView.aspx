<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfileView.aspx.cs" Inherits="Evant.Views.ProfileView" %>
            ...
            <header id="masthead" class="site-header  " role="banner">
                ...
                <nav id="site-navigation" class="menu-wrapper" role="navigation">
                    ...
                    <ul id="menu-main-menu" class="primary-menu">
                        <li id="menu-item-1" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-861">
                            <button runat="server" onserverclick="Settings_Click">Settings</button>
                        </li>
                        <li id="menu-item-2" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-861">
                                ...
                                <div class="grid">
                                    <header class="entry-header">
                                        <div style="display: flex">
                                            <div style="vertical-align: central; padding-right: 1rem; align-self: center" class="comment-author vcard">
                                                <ol class="comment-list">
                                                    <asp:Image runat="server" src="/Views/assets/img/user-profile.jpg" srcset="/Views/assets/img/user-profile.jpg 2x" class="avatar avatar-75 photo" Height="75" Width="75" originals="75" src-orig="/Views/assets/img/user-profile.jpg" scale="2" />
                                                </ol>
                                            </div>
                                            <div>
                                                <h1 class="entry-title" runat="server" id="Name"></h1>
                                                <span class="entry-subtitle" runat="server" id="Email"></span>
                                            </div>
                                        </div>
                                    </header>
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div id="comments" class="comments-area">
                                                                    <ol class="comment-list">
                                                                        <asp:ListView ID="EventsListView" runat="server">
                                                                            <LayoutTemplate>
                                                                                <span style="width: 33%">My Events</span>
                                                                                <asp:PlaceHolder ID="itemPlaceHolder" runat="server" />
                                                                            </LayoutTemplate>
                                                                            <ItemTemplate>
                                                                                <div style="display: flex; padding-top: 2rem; padding-bottom: 2rem; width: 100%" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-927 comment">
                                                                                    <asp:Image CssClass="list-image" Height="60px" ImageUrl="/views/assets/img/events.png" runat="server" />
                                                                                    <div style="display: flex">
                                                                                        <div>
                                                                                            <div style="display: flex; text-align: left">
                                                                                                <asp:Label ID="lblName" runat="server" Text='<%#Eval("EventName")%>' ForeColor="Black" Font-Bold="true" Font-Size="Medium"></asp:Label>
                                                                                            </div>
                                                                                            <div style="text-align: left">
                                                                                                <asp:Label ID="Label3" runat="server" Text='<%#Eval("City")%>' Font-Size="Small"></asp:Label>
                                                                                            </div>

                                                                                            <div style="text-align: left">
                                                                                                <asp:Label runat="server" Text='Baslangiç : ' ForeColor="Coral" Font-Size="Small"></asp:Label>
                                                                                                <asp:Label ID="lblStartDate" runat="server" Text='<%#Eval("StartDate") %>' ForeColor="Coral" Font-Size="Small"></asp:Label>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div style="text-align: end; align-self: center; vertical-align: central; padding-left: 2rem">
                                                                                            <asp:LinkButton Style="font-size: small" runat="server" ID="EventButton" CommandArgument='<%#Eval("Id") %>' OnCommand="EventClick" Text="Go to Details >"></asp:LinkButton>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </ItemTemplate>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div id="listing_comments-2" class="widget  widget_listing_comments">
                                                                <div id="comments" class="comments-area">
                                                                    <ol class="comment-list">
                                                                        <asp:ListView ID="FollowerListView" runat="server">
                                                                            <LayoutTemplate>
                                                                                <span>Followers</span>
                                                                                <asp:PlaceHolder ID="itemPlaceHolder" runat="server" />
                                                                            </LayoutTemplate>
                                                                            <ItemTemplate>
                                                                                <div style="display: flex; padding-top: 1rem; padding-bottom: 1rem; width: 100%" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-927 comment">
                                                                                    <div style="vertical-align: central; padding-right: 1rem; align-self: center" class="comment-author vcard">
                                                                                        <asp:Image runat="server" src="/Views/assets/img/user-profile.jpg" srcset="/Views/assets/img/user-profile.jpg 2x" class="avatar avatar-75 photo" Height="75" Width="75" originals="75" src-orig="/Views/assets/img/user-profile.jpg" scale="2" />
                                                                                    </div>
                                                                                    <div style="display: flex; width: 100%">
                                                                                        <div style="text-align: left; align-self: center; vertical-align: central; width: 60%">
                                                                                            <asp:Label ID="FollowerName" runat="server" Text='<%#Eval("Name")%>' Font-Size="Medium"></asp:Label>
                                                                                        </div>
                                                                                        <div style="text-align: end; align-self: center; vertical-align: central; width: 40%">
                                                                                            <asp:LinkButton Style="font-size: small" runat="server" ID="FollowingButton" CommandArgument='<%#Eval("Id") %>' OnCommand="PersonClick" Text="Go to Details >"></asp:LinkButton>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </ItemTemplate>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div id="listing_comments-2" class="widget  widget_listing_comments">
                                                                <div id="comments" class="comments-area">
                                                                    <ol class="comment-list">
                                                                        <asp:ListView ID="FollowingListView" runat="server">
                                                                            <LayoutTemplate>
                                                                                <span>Followings</span>
                                                                                <asp:PlaceHolder ID="itemPlaceHolder" runat="server" />
                                                                            </LayoutTemplate>
                                                                            <ItemTemplate>
                                                                                <div style="display: flex; padding-top: 1rem; padding-bottom: 1rem" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-927 comment">
                                                                                    <div style="vertical-align: central; padding-right: 1rem; align-self: center" class="comment-author vcard">
                                                                                        <asp:Image runat="server" src="/Views/assets/img/user-profile.jpg" srcset="/Views/assets/img/user-profile.jpg 2x" class="avatar avatar-75 photo" Height="75" Width="75" originals="75" src-orig="/Views/assets/img/user-profile.jpg" scale="2" />
                                                                                    </div>
                                                                                    <div style="display: flex;">
                                                                                        <div style="display: flex; width: 100%">
                                                                                            <div style="text-align: left; align-self: center; vertical-align: central; align-self: center; width: 60%">
                                                                                                <asp:Label ID="FollowingName" runat="server" Text='<%#Eval("Name")%>' Font-Size="Medium"></asp:Label>
                                                                                            </div>
                                                                                            <div style="width: 40%; align-self: center; vertical-align: central;">
                                                                                                <div style="text-align: end;">
                                                                                                    <asp:LinkButton ID="FollowingButton" ForeColor="White" CssClass="btn" Text="Unfollow" OnCommand="FollowingClick" CommandName="FollowingClick" CommandArgument='<%#Eval("Id") %>' runat="server" />
                                                                                                </div>
                                                                                                <div style="text-align: left; cursor: pointer; vertical-align: bottom; width: 100%">
                                                                                                    <asp:LinkButton Style="font-size: small" runat="server" ID="LinkButton1" CommandArgument='<%#Eval("Id") %>' OnCommand="PersonClick" Text="Go to Details >"></asp:LinkButton>
                                                                                                </div>
                                                                                            </div>
