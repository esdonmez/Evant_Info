<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterView.aspx.cs" Inherits="Evant.Views.RegisterView" %>
    ...
    <div class="lwa">
        <div class="lwa-modal" style="display: block; top: 100px; opacity: 1; visibility: visible;">
            <form runat="server" name="lwa-register" class="lwa-register  lwa-form  js-lwa-register form-visible">
                <p>
                    <label class="color" for="username">Name Surname *</label>
                    <input runat="server" name="user_login" id="user_name" type="text">
                </p>
                <p>
                    <label class="color" for="email">Email *</label>
                    <input runat="server" name="user_login" id="user_email" type="text">
                </p>
                <p>
                    <label class="color" for="user_email">Password *</label>
                    <input runat="server" name="user_email" id="user_password" type="password">
                </p>
                <p class="lwa-submit-wrapper">
                    <button runat="server" onserverclick="Register_Click" type="submit"><span class="button-arrow">Register</span></button>
                </p>
                <p class="lwa-bottom-text">Already have an account? <a href="/Views/LoginView.aspx" class="lwa-action-link  js-lwa-close-register-form">Log in</a></p>
            </form>
