<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUserView.aspx.cs" Inherits="Evant.Views.AdminView.AdminUserView" %>
                ...
                <div class="container">
                    <div id="navigation" class="active">
                        <ul class="navigation-menu">
                            <li>
                                <asp:LinkButton runat="server" Text="Logout" OnClick="Logout_Click"></asp:LinkButton></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="table-responsive">
                                <asp:ListView runat="server" ID="UserListView">
                                    <LayoutTemplate>
                                        <table class="table table-actions-bar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: left">Access Token</th>
                                                    <th style="text-align: left">Action</th>
                                                    <th style="min-width: 80px; text-align: left">Add Event</th>
                                                </tr>
                                            </thead>
                                    ...
                                    <ItemTemplate>
                                        <tbody style="direction: ltr">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label runat="server" Text='<%#Eval("Name")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label runat="server" Text='<%#Eval("Email")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label runat="server" Text='<%#Eval("AccessToken")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                </td>
                                                <td>
                                                    ...
                                                    <asp:LinkButton runat="server" OnCommand="Edit_Command" CommandArgument='<%#Eval("Id")%>'><img style="width:5%" src="assets/images/edit.png"></img></asp:LinkButton>
                                                </td>
                                                <td>
                                                    <asp:LinkButton runat="server" OnCommand="AddEvent_Command" CommandArgument='<%#Eval("Id")%>'><img style="width:10%; align-self" src="assets/images/add.png"/></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </ItemTemplate>
