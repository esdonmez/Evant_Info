<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEventView.aspx.cs" Inherits="Evant.Views.AdminView.AdminEventView" %>
...
<body style="direction: ltr">
    <div class="custombox-container custombox-container-fadein custombox-container-open">
        <form runat="server">
            <header id="topnav">
                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                <div class="table-responsive">
                                    <asp:ListView runat="server" ID="EventListView">
                                        <LayoutTemplate>
                                        ...
                                        <ItemTemplate>
                                            <tbody style="direction: ltr">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" Text='<%#Eval("City")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label runat="server" Text='<%#Eval("StartDate")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label runat="server" Text='<%#Eval("CreateDate")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label runat="server" Text='<%#Eval("Category")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                    </td>
                                                    <td>
