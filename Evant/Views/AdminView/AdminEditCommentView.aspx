<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEditCommentView.aspx.cs" Inherits="Evant.Views.AdminView.AdminEditCommentView" %>
                                    ...
                                    <div class="custom-modal-text text-left">
                                        <div>
                                            <div class="form-group">
                                                ...
                                                <input runat="server" type="email" class="form-control" id="title" placeholder="Title">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Content</label>
                                                <input runat="server" type="email" class="form-control" id="content" placeholder="Content">
                                            </div>
