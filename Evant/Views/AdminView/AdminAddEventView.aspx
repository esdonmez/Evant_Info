<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAddEventView.aspx.cs" Inherits="Evant.Views.AdminView.AdminAddEventView" %>
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="table-responsive" runat="server">
                                <div>
                                    <h4 class="custom-modal-title">Edit Event</h4>
                                    <div class="custom-modal-text text-left">
                                        <div>
                                            <div class="form-group">
                                                <label for="name">Event Name</label>
                                                <input runat="server" type="text" class="form-control" id="eventName" placeholder="Event name">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail1">City</label>
                                                <input runat="server" type="email" class="form-control" id="city" placeholder="City">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Start Date</label>
                                                <input runat="server" type="email" class="form-control" id="startDate" placeholder="Start date">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Description</label>
                                                <input runat="server" type="email" class="form-control" id="description" placeholder="Description">
                                            </div>
