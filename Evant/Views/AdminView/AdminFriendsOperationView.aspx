<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFriendsOperationView.aspx.cs" Inherits="Evant.Views.AdminView.AdminFriendsOperationView" %>
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="table-responsive">
                                <asp:ListView runat="server" ID="FriendsOperationListView">
                                    <LayoutTemplate>
                                        <table class="table table-actions-bar">
                                            <thead>
                                                <tr>
                                                    <th style="text-align: left">Id</th>
                                                    <th style="text-align: left">Follower Name</th>
                                                    <th style="text-align: left">Followed Name</th>
                                    ...
                                    <ItemTemplate>
                                        <tbody style="direction: ltr">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label runat="server" Text='<%#Eval("Followed")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label runat="server" Text='<%#Eval("Follower")%>' Font-Bold="true" Font-Size="12px" ForeColor="#000"></asp:Label>
                                                </td>
                                                <td>
